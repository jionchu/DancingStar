...
@Service
@Slf4j
public class PoseEstimationAPIService {

    @Value("${ncloud.client.id}")
    String clientId;

    @Value("${ncloud.client.secret}")
    String clientSecret;

    public String callAPI(String imageFile){

        StringBuffer reqStr = new StringBuffer();
        ClassPathResource classPathResource = new ClassPathResource(imageFile);
        ...
        try {
            ...
            throw new NcloudException("error!!");
        }
    }
}
